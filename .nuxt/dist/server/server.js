...
/******/ 			var chunk = require("./" + ({"1":"components/answer-wait-post","2":"components/answer-wait-reply","3":"components/shared-send-sentence","4":"pages/index"}[chunkId]||chunkId) + ".js");
...
/* harmony default export */ __webpack_exports__["a"] = ({
  modifyUrlInPost(posts, property) {
    posts.map(post => {
      const url = post[property].match(/((https?):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi);
      post[property] = post[property].replace(/((https?):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi, '<a href="' + url + '" target="_blank">こちら</a>');
    });
  },
...
const _348db9b7 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 4).then(__webpack_require__.bind(null, 51)));
...
const AnswerWaitPost = () => __webpack_require__.e(/* import() | components/answer-wait-post */ 1).then(__webpack_require__.bind(null, 43)).then(c => wrapFunctional(c.default || c));
const AnswerWaitReply = () => __webpack_require__.e(/* import() | components/answer-wait-reply */ 2).then(__webpack_require__.bind(null, 44)).then(c => wrapFunctional(c.default || c));
const SharedSendSentence = () => __webpack_require__.e(/* import() | components/shared-send-sentence */ 3).then(__webpack_require__.bind(null, 34)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
...
// CONCATENATED MODULE: ./.nuxt/templates.plugin.3170ba5c.js
...
/* Plugins */
 ...
 // Source: ./templates.plugin.3170ba5c.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof /* Cannot get final name for export "default" in "./.nuxt/templates.plugin.3170ba5c.js" (known exports: , known reexports: ) */ undefined === 'function') {
    await /* Cannot get final name for export "default" in "./.nuxt/templates.plugin.3170ba5c.js" (known exports: , known reexports: ) */ undefined(app.context, inject);
  }
